...
class BuildScript:
    ...
    def __init__(self):
        ...
        self.specs = [
            ("specs/network_terminal.spec", "NetworkTerminal.exe"),
        ]
    ...
    def clean_build_artifacts(self):
        ...
        self.print_step(1, 3, "Cleaning previous build artifacts")
    ...
    def build_executable(self, spec_file, exe_name, step_num):
        ...
        self.print_step(step_num, 3, f"Building {exe_name}")
    ...
    def verify_outputs(self):
        ...
        self.print_step(3, 3, "Verifying build outputs")
